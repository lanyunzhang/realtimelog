...
BEGIN {
    ...
    eval {
        ...
        bootstrap ListMoreUtils $VERSION;
        1;
...
ListMoreUtils - Provide the stuff missing in ListUtil

=head1 SYNOPSIS

    use ListMoreUtils qw{
        any all none notall true false
        firstidx first_index lastidx last_index
        insert_after insert_after_string
        apply indexes
...
B<ListMoreUtils> provides some trivial but commonly needed functionality on
lists which is not going to go into L<ListUtil>.
...
drop me a line. This module's policy will be less strict than L<ListUtil>'s
...
tidier by making L<ListUtils> obsolete. 

Brian McCauley suggested the inclusion of apply() and provided the pure-Perl
implementation for it.

Eric J. Roode asked me to add all functions from his module C<ListMoreUtil>
...
=item * ListUtil export pass-through

Allow B<ListMoreUtils> to pass-through the regular L<ListUtil>
